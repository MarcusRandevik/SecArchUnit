...
\section{Collection of Security constraint}
...
\subsection{Enforce AuthN/AuthZ at single point} \checkmark
...
\subsection{Validate user input} \checkmark
...
\subsection{Secrets must not be exposed in log messages} \checkmark
