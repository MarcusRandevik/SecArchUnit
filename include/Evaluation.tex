...
While this thesis shows that such analysis is possible in Java, the approach should be generalizable to any object oriented language where types are known at compile-time, i.e. statically typed object oriented languages. %An example includes C\#, for which SonarQube already has custom rule support. https://github.com/SonarSource/sonar-dotnet
