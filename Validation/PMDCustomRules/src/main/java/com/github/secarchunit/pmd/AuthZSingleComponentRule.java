...
public class AuthZSingleComponentRule extends AbstractJavaRule {
    private static final String AUTH_POINT = "org.mybatis.jpetstore.web.actions.OrderActionBean";
    private static final String AUTH_ENFORCER = "org.mybatis.jpetstore.web.actions.OrderActionBean";
