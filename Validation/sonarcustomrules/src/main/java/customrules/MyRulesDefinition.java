...
public class MyRulesDefinition implements RulesDefinition {
    ...
    // TODO entire class is copied, might need to change these variables
    ...
    private void addMetadata(NewRule rule, String metadataKey) {
        URL resource = MyRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
        if (resource != null) {
    ...
    private static void addHtmlDescription(NewRule rule, String metadataKey) {
        URL resource = MyRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
        if (resource != null) {
