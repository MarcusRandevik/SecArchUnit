...
@Rule(
        key = "AuthZSingleComponentRule",
        name = "AuthZ is enforced in a single component",
        description = "Authorization must be enforced in a single component",
        tags = "secarchunit",
        priority = Priority.MAJOR
)
public class AuthZSingleComponentRule extends IssuableSubscriptionVisitor {
